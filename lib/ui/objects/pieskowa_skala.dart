...
class PieskowaSkalaPage extends StatefulWidget {
  const PieskowaSkalaPage({required this.title, super.key});
  final String title;
  @override
  _PieskowaSkalaPageState createState() => _PieskowaSkalaPageState();
}

class _PieskowaSkalaPageState extends State<PieskowaSkalaPage> {
