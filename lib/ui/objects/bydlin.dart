...
class BydlinPage extends StatefulWidget {
  const BydlinPage({required this.title, super.key});
  final String title;
  @override
  _BydlinPageState createState() => _BydlinPageState();
}

class _BydlinPageState extends State<BydlinPage> {
