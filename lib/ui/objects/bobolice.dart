...
class BobolicePage extends StatefulWidget {
  const BobolicePage({required this.title, super.key});
  final String title;
  @override
  _BobolicePageState createState() => _BobolicePageState();
}

class _BobolicePageState extends State<BobolicePage> {
