...
class OstreznikPage extends StatefulWidget {
  const OstreznikPage({required this.title, super.key});
  final String title;
  @override
  _OstreznikPageState createState() => _OstreznikPageState();
}

class _OstreznikPageState extends State<OstreznikPage> {
